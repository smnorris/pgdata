"""
Just to stop sqlalchemy from complaining. Untested and unused.

directly from https://github.com/DisruptiveLabs/sqlalchemy_postgresql_json/blob/master/sqlalchemy_postgresql_json/ltree.py
"""
